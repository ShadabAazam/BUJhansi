...
public class ShowNearest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dataUrl= "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location="+a+","+b+"&radius=500&types="+ input +"&sensor=false&key=AIzaSyBYim7RY_8oUxXfBxnJCb0jjgPCDrFr790";
        makeRequest();
    }
