    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firstValueListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                list.clear();
                /*UserBean userBean = RefrenceWrapper.getRefrenceWrapper(NoticeBoardActivity.this).getUserBean();
        ...
        // single event notification is being getting over here to substract it from value event listener
